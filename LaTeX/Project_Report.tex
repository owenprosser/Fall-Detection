...
The overall aim of this project is to create a fall detection system using the Python programming language and its OpenCV library.
...
Using version control and safely backing up a code base can be a vital part of any programming project. The Python code and other related files were version controlled and backed up securely using Git. An example of the Git usage is shown in Appendix A: Figure \ref{fig:GitCommitPush} illustrating all the commands necessary for a 'git commit' and 'git push'.

At the beginning of the project Gantt Charts were used to plan how the available time was going to be used though out the development process
...
\begin{figure}[H]
 ...
 \caption{Original Gantt Chart for the project timescale}
 \label{fig:OriginalGantt}
\end{figure}

\begin{figure}[H]
 \centering
 \includegraphics[scale = 0.4]{gitpush.png}
