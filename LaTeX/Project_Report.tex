...
techniques found in the literature review).
	\item Test the system thoroughly to ensure that it can detect a fall whilst minimizing false positives.
    \item The system must process the video in real-time so that there is not a growing back-log of video frames which could cause the system to fill it's available memory.
    \end{itemize}
\end{enumerate}
...
\begin{figure}[H]
 ...
 \caption{Screen shot of the Git Repository Hosted on GitHub.com}
 \label{fig:GitRepo}
\end{figure}
